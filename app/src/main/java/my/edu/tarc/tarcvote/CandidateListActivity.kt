                        ...
                        .addOnSuccessListener {
                            ...
                            imageRef.delete()
                                ...
                                .addOnFailureListener {
                                    ...
                                    Toast.makeText(this, "Error deleting image: ${it.message}", Toast.LENGTH_LONG).show()
                                }
                        }
                        .addOnFailureListener {
                            // An error occurred while deleting the candidate document
                            Toast.makeText(this, "Error deleting candidate: ${it.message}", Toast.LENGTH_LONG).show()
                        }
                })
